...
# Run tests (skip migration suite — needs credential serialization fix, see follow-up issue)
xcodebuild test -project "Claude Usage.xcodeproj" -scheme "Claude Usage" -configuration Debug CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO CODE_SIGNING_ALLOWED=NO -skip-testing:"Claude UsageTests/KeychainPerProfileMigrationServiceTests"
